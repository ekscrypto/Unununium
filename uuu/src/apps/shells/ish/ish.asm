;; $Header: /cvsroot/uuu/uuu/src/apps/shells/ish/ish.asm,v 1.30 2001/12/18 02:03:08 daboy Exp $
;;
;; Ish shell
...
version_info:	dstring '$Id: ish.asm,v 1.30 2001/12/18 02:03:08 daboy Exp $'
version_str:	dstring "$Revision: 1.30 $"
