...
initialization:
  ...
  mov esi, strings.found
  jmp short .endall


.failed:
  mov esi, strings.notfound
.endall:
...
strings:
.notfound: db "[KEROSEN] Couldn't find PCI Bios, aborting installation",0
.found: db "[KEROSEN] PCI Bios detected, installation completed",0
