;; $Header: /cvsroot/uuu/uuu/src/cells/fs/devfs/devfs.asm,v 1.16 2002/01/04 18:44:42 lukas2000 Exp $
;;
...
init:
  jmp short .start
  .init_done: db "[DevFS] Initialization completed ($Revision: 1.16 $)",0
...
.start:
  ...
  lprint {"devfs: version $Revision: 1.16 $ loaded",0xa}, LOADINFO
