;; $Header: /cvsroot/uuu/uuu/src/cells/fs/ext2/ext2.asm,v 1.43 2001/12/09 17:03:27 instinc Exp $
;;
...
str_title: db "Second Extended File System $Revision: 1.43 $",0
str_author: db "eks",0
...
;=----------------------------------------------------------------------------=
  ...
  pushad				; make sure to backup registers
  ...
  popad					; restore them, not disturbing system
