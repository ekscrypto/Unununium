;; $Header: /cvsroot/uuu/uuu/src/cells/memory_manager/oxygen/oxygen.asm,v 1.58 2001/12/19 02:11:06 daboy Exp $
;;
;; Wave ]|[ Oxygen
;;  .: by EKS :.
;;
...
clc	; XXX tempoarily disabled by indigo; it is uncirtain if there is a bug
retn	; in this function, or if it's memory corruption. Further testing is
	; being done, but for now this seems to be the only way to make the
	; system stable.
;>
